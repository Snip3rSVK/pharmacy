...
public class DrugsDatabase {
    ...
    private void initializeDrugs() {
        ...
        this.allDrugs.add(new Drug("07/0066/73-S", 25544, "ACYLPYRIN 500 mg šumivé tablety", "tbl eff 20x500 mg (tuba PP)", acylpyrinManufacturer, acylpyrinSuppliers, false));
    }
}
